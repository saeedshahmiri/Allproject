...
try:
    ...
    df_postgres.show(3)
    df_postgres = df_postgres.limit(1000)
    #-+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+-
    #-+-+--+-+--+-+--+-+--+-+-Transformations-+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+-
    ##-+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+--+-+-
    ...
    # Create database
    #spark.sql("CREATE DATABASE IF NOT EXISTS sdata124")

    # Hive database and table names
    hive_database_name = "sdata124"
    hive_table_name = "data_bank_pyspark"
